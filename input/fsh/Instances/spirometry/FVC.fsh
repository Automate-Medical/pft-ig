...
Usage: #example
// TODO: The narrative here will essentially be the body text of the IG HTML page this instance lives in.
//       For now we comment it out because it will overwrite the autogenerated text.
...
* id = "FVC-PRE"
* status = #final
* category = $FHIR_ObservationCategory#procedure "Procedure" // TODO: Valid coding?
* code = $LNC#19876-2 "Forced vital capacity [Volume] Respiratory system by Spirometry --pre bronchodilation"
// I thought these could be cool for detailed examples, but they're beyond our current scope.
// Commented out because they will raise errors in IG build process, due to the referenced resources being #inline Instances.
...
* referenceRange
  ...
  * type
    * text = "FVC normal bounds"
* extension[testQuality].valueString = "B"
* extension[referenceValueSource].valueString = "GLI 2012"
